    ...
    'columns' => [
        ...
        'l10n_parent' => array(
            ...
            'config' => array(
                ...
                'foreign_table' => 'tx_obd_domain_model_obd',
                'foreign_table_where' => 'AND tx_obd_domain_model_obd.pid=###CURRENT_PID### AND tx_obd_domain_model_obd.sys_language_uid IN (-1,0)',
            ),
        ),
