...
class TermsController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * termsRepository
     *
     * @var \DRAKE\Obd\Domain\Repository\TermsRepository
     * @inject
     */
    ...
    public function listAction()
    {
        ...
        $newTerms = $this->objectManager->get(\DRAKE\Obd\Domain\Model\Terms::class);
     ...
     * action add
     *
     * @param \DRAKE\Obd\Domain\Model\Terms $newTerms
     * @return void
     */
    public function addAction(\DRAKE\Obd\Domain\Model\Terms $newTerms)
    {
    ...
    public function importAction()
    {
        ...
        $input = (string)$_POST['tx_obd_terms']['description'];
        $outp = [];
